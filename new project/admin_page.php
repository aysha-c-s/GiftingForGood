...
if (isset($_POST['delete'])) {
  ...
  $delete_query = "DELETE FROM notice WHERE N_id = $notice_id";
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light fixed-top">
            <div class="container">
                ...
                <div class="d-flex">
                    <button class="btn btn-primary me-2" type="button" onclick="location.href='notice.php'">Create Notice</button>
        ...
        <section class="tabs-section">
            <div class="container">
                ...
                <div class="tab-content" id="myTabContent">
                    ...
                    <!-- Notice Info Tab -->
                    <div class="tab-pane fade show active" id="notice-info" role="tabpanel" aria-labelledby="notice-info-tab">
                        <table class="table table-striped mt-3">
                        <thead>
                            <tr>
